...
#define PCI_ID_CODE(vid, pic)\
    ((((vid) & PCI_VENDOR_MASK) << PCI_VENDOR_SHIFT) | \
    (((pid) & PCI_PRODUCT_MASK) << PCI_PRODUCT_SHIFT))

/*
 * PCI Bus Header
 * 	Built-In Self Test Shift
 * 	Built-In Self Test Mask
 * 	Header Type Shift
 * 	Header Type Mask
 * 	Latency Timer Shift
 * 	Latency Timer Mask
 * 	Cacheline Size Shift
 * 	Cacheline Size Mask
 * 	Built-In Self Test Set
 * 	Header Type Set
 * 	Header Type Type
 * 	Is PCI Header Type PPB
 * 	Multi-Function Set
 * 	Latency Timer Set
 * 	Cacheline Size Set
 */
...
#define PCI_INTTERUPT_PIN_MASK		0xff
...
/*
 * PCI Class and Subclass Register
 * 	Class Shift
 * 	Class Mask
 * 	Subclass Shift
 * 	Subclass Mask
...
#define PCI_MAPREG_ADDR_MASK		0xfffffff0
